...
SECRET_KEY = '$0&!rx709a_$a+)(4i!)+4!x!q!(1-*3l^jr$z05r$283qv8ir'
...
# -----------------------------------------------------------------------------------------------
# jwt override file -> dino.serializers.jwt_response_payload_handler 파일 include 하기위해 정의한거.. 이외에도 session 관련도 정의 여기다 하는듯
JWT_AUTH = {
